...
SPRITESHEET_TEMPLATE = (
    ...
    "*** CRITICAL: EVERY ROW MUST SHOW A VISIBLY DIFFERENT BODY POSE! ***\n"
    "The #1 failure mode is making all rows look the same. "
    "If rows look similar, the animation will be broken and unusable.\n"
    "Each row MUST have DRAMATICALLY different arm and leg positions.\n"
    "Imagine a stop-motion animation — each row is a frozen moment of action.\n\n"

    "The character, outfit, and colors stay identical across all rows "
    "— ONLY the body position changes. Each pose is described below:\n\n"

    "  Row 1 — IDLE (standing still):\n"
    "    Body upright, weight evenly on both feet, shoulders relaxed.\n"
    "    {idle_desc}.\n"
    "    LEGS: Both feet flat on ground, shoulder-width apart.\n"
    "    ARMS: Relaxed at sides or lightly holding weapon.\n"
    "    This is the default resting pose — a calm, balanced stance.\n\n"

    "  Row 2 — WALK FRAME 1 (LEFT foot forward — BIG STRIDE):\n"
    "    *** LEGS MUST BE SPREAD FAR APART — visible gap between feet! ***\n"
    "    LEFT leg extended FORWARD (heel touching ground), RIGHT leg stretched BEHIND.\n"
    "    The gap between feet should be at least 30% of body height.\n"
    "    Body leans forward. RIGHT arm forward, LEFT arm back (opposite to legs).\n"
    "    Like a freeze-frame of someone mid-step. NOT like standing still.\n\n"

    "  Row 3 — WALK FRAME 2 (RIGHT foot forward — BIG STRIDE):\n"
    "    *** EXACT MIRROR of Row 2! ***\n"
    "    RIGHT leg extended FORWARD, LEFT leg stretched BEHIND.\n"
    "    LEFT arm forward, RIGHT arm back.\n"
    "    The legs MUST be the OPPOSITE of Row 2 — if Row 2 has left foot forward, "
    "Row 3 has right foot forward. Compare them side by side!\n\n"

    "  Row 4 — WALK FRAME 3 (feet together, passing position A):\n"
    "    *** BOTH FEET CLOSE TOGETHER under the body! ***\n"
    "    This is the OPPOSITE of Rows 2-3 (which had feet apart).\n"
    "    Legs nearly touching — one foot is about to lift off the ground.\n"
    "    Body upright and tall (taller than Rows 2-3 since not lunging).\n"
    "    Arms close to body. Weight on RIGHT foot.\n\n"

    "  Row 5 — WALK FRAME 4 (feet together, passing position B):\n"
    "    *** Same as Row 4 but weight on LEFT foot instead. ***\n"
    "    Both feet close together, body upright.\n"
    "    Subtle shift — body weight on the opposite side from Row 4.\n"
    "    Together Rows 2→4→3→5 create a smooth 4-frame walk cycle.\n\n"

    "  Row 6 — ATTACK WIND-UP (preparing to strike):\n"
    "    *** WEAPON PULLED BACK, BODY COILED! ***\n"
    "    This MUST look dramatically different from idle (Row 1).\n"
    "    Knees deeply bent, body crouched lower than idle stance.\n"
    "    Weapon drawn BACK behind the head/shoulder — maximum recoil.\n"
    "    Arms pulled far back, torso twisted. Coiled like a spring.\n"
    "    Weight on back foot, front foot barely touching ground.\n\n"

    "  Row 7 — ATTACK STRIKE (weapon extended):\n"
    "    *** WEAPON THRUST/SWUNG FAR FORWARD! ***\n"
    "    {attack_desc}.\n"
    "    Body lunged FORWARD — front knee deeply bent, back leg straight.\n"
    "    Weapon fully EXTENDED at maximum reach in front of the body.\n"
    "    This is the moment of IMPACT — total opposite of Row 6.\n"
    "    Arms stretched out, torso rotated forward. Maximum extension.\n\n"

    "  Row 8 — HIT REACTION (taking damage):\n"
    "    *** BODY JERKED BACKWARD, OFF-BALANCE! ***\n"
    "    Body recoiling from a blow to the chest — leaning FAR back.\n"
    "    Head snapped backward, one arm flung up defensively.\n"
    "    Knees buckling, feet stumbling. Clearly in pain.\n"
    "    This MUST look like the character was just punched hard.\n"
    "    Weight falling backward — opposite of Row 7's forward lunge.\n\n"
