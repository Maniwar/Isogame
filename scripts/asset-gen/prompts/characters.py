...
SPRITESHEET_TEMPLATE = (
    ...
    "- CHARACTER SIZING: The character must be NO TALLER than 200 pixels and NO WIDER "
    "than 180 pixels within each 256×256 cell. This leaves at least 28 pixels of "
    "clear green padding on each side and 28 pixels above and below. The character "
    "MUST NOT touch or extend to the cell edges. Keep a visible green margin on ALL "
    "four sides of every cell.\n"
    "- The character is centered horizontally and anchored to the bottom of each cell "
    "(feet near the bottom edge but with 20+ pixels of green space below).\n"
    ...
    "- ABSOLUTELY NO dark outlines or black borders drawn around the character. "
    "The character is a 3D pre-render, NOT outlined cartoon art. Edges transition "
    "directly from character to green background with NO drawn border line.\n"
